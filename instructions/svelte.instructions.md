...
## description: 'Svelte 5 and SvelteKit development standards and best practices for component-based user interfaces and full-stack applications' applyTo: '\*\*/_.svelte, \*\*/_.ts, \*\*/_.js, \*\*/_.css, \*\*/_.scss, \*\*/_.json'

# Svelte 5 and SvelteKit Development Instructions

Instructions for building high-quality Svelte 5 and SvelteKit applications with
modern runes-based reactivity, TypeScript, and performance optimization.
...
- Use `$derived()` for expensive computations to avoid unnecessary
  recalculations
...
1. Define TypeScript interfaces and component props
1. Implement core components with Svelte 5 runes
1. Add routing, layouts, and navigation with SvelteKit
1. Implement data loading and form handling
1. Add styling system with custom properties and responsive design
...
1. Deploy with appropriate SvelteKit adapter

## Additional Guidelines

- Follow Svelte's naming conventions (PascalCase for components, camelCase for
  functions)
