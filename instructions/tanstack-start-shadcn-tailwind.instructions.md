...
## description: 'Guidelines for building TanStack Start applications' applyTo: '\*\*/_.ts, \*\*/_.tsx, \*\*/_.js, \*\*/_.jsx, \*\*/_.css, \*\*/_.scss, \*\*/\*.json'

# TanStack Start with Shadcn/ui Development Guide

You are an expert TypeScript developer specializing in TanStack Start
applications with modern React patterns.
...
Structure routes in `src/routes/` with file-based routing. Always include error
