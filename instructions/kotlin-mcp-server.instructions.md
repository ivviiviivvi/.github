...
## description: 'Best practices and patterns for building Model Context Protocol (MCP) servers in Kotlin using the official io.modelcontextprotocol:kotlin-sdk library.' applyTo: "\*\*/_.kt, \*\*/_.kts, \*\*/build.gradle.kts, \*\*/settings.gradle.kts"

# Kotlin MCP Server Development Guidelines

When building MCP servers in Kotlin, follow these best practices and patterns
