...
## description: 'Best practices and patterns for building Model Context Protocol (MCP) servers in Swift using the official MCP Swift SDK package.' applyTo: "\*\*/\*.swift, \*\*/Package.swift, \*\*/Package.resolved"

# Swift MCP Server Development Guidelines

When building MCP servers in Swift, follow these best practices and patterns
using the official Swift SDK.
