...
## description: Comprehensive development guidelines for Microsoft 365 Copilot declarative agents with schema v1.5, TypeSpec integration, and Microsoft 365 Agents Toolkit workflows applyTo: "\*\*.json, \*\*.ts, \*\*.tsp, \*\*manifest.json, \*\*agent.json, \*\*declarative-agent.json"

# Microsoft 365 Declarative Agents Development Guidelines

## Overview

Microsoft 365 Copilot declarative agents are powerful custom AI assistants that
extend Microsoft 365 Copilot with specialized capabilities, enterprise data
access, and custom behaviors. These guidelines provide comprehensive development
practices for creating production-ready agents using the latest v1.5 JSON schema
specification with full Microsoft 365 Agents Toolkit integration.
...
1. **OneDriveAndSharePoint**: File access, document search, content management
1. **GraphConnectors**: Enterprise data integration from third-party systems
1. **MicrosoftGraph**: Access to Microsoft 365 services and data

### Communication & Collaboration

5. **TeamsAndOutlook**: Teams chat, meetings, email integration
1. **CopilotForMicrosoft365**: Advanced Copilot features and workflows

### Business Applications

7. **PowerPlatform**: Power Apps, Power Automate, Power BI integration
1. **BusinessDataProcessing**: Advanced data analysis and processing
1. **WordAndExcel**: Document creation, editing, analysis
1. **EnterpriseApplications**: Third-party business system integration
1. **CustomConnectors**: Custom API and service integrations
...
1. **Conversation Flow**: Validate conversation starters
1. **Error Handling**: Test invalid inputs and edge cases
1. **Performance**: Measure response times and reliability
...
1. **Capability Conflicts**: Verify capability combinations are supported
1. **Performance Issues**: Monitor response times and optimize instructions
1. **Deployment Failures**: Validate environment configuration and permissions
...
This comprehensive guide ensures robust, scalable, and maintainable Microsoft
365 Copilot declarative agents with full TypeSpec and Microsoft 365 Agents
Toolkit integration.
