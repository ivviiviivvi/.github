...
class TestLinkExtraction(unittest.TestCase):
    ...
    def test_url_with_trailing_punctuation(self):
        ...
        self.assertTrue(any(url.startswith("https://example.com") for url in urls))  # lgtm [py/incomplete-url-substring-sanitization]
        self.assertTrue(any(url.startswith("https://github.com") for url in urls))  # lgtm [py/incomplete-url-substring-sanitization]
        self.assertTrue(any(url.startswith("https://test.com") for url in urls))  # lgtm [py/incomplete-url-substring-sanitization]
