...
- **Issues**:
  [Create an issue](https://github.com/{{ORG_NAME}}/.github/issues)<!-- link:github.issues -->
- **Discussions**:
  [Join the discussion](https://github.com/{{ORG_NAME}}/.github/discussions)<!-- link:github.discussions -->
