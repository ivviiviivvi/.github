...
- [ ] Read [WORKFLOW_DESIGN.md](../../docs/workflows/WORKFLOW_DESIGN.md) - Architecture
  overview
- [ ] Review
  [WORKFLOW_IMPLEMENTATION_SUMMARY.md](../../docs/reports/WORKFLOW_IMPLEMENTATION_SUMMARY.md)
  \- Deployment guide
- [ ] Check [CONTRIBUTOR_WORKFLOW.md](../../docs/workflows/CONTRIBUTOR_WORKFLOW.md) -
  User-facing guide
...
- [ ] Cover key topics:
  ...
  - [ ] Handling edge cases
- [ ] Walk through [MAINTAINER_WORKFLOW.md](../../docs/workflows/MAINTAINER_WORKFLOW.md)
- [ ] Q&A session
