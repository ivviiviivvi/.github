...
This document provides instructions for testing the commit tracking
functionality.
...
The commit tracking workflow runs automatically on pushes to `main` or `develop`
branches and on pull request updates.
...
1. Review the workflow summary for commit statistics

### Testing Weekly Commit Report

The weekly report runs every Monday at 9:00 AM UTC, but can also be triggered
manually:

1. Go to the Actions tab in GitHub
1. Select "Weekly Commit Report" workflow
1. Click "Run workflow"
1. Click the green "Run workflow" button to confirm
1. Wait for the workflow to complete
1. Check the `reports/` directory for the generated report
...
1. Display current commit information (SHA, author, branch, message)
1. Show pull request commits (if applicable)
1. Validate the commit message is not empty
1. Generate statistics for last 10 commits
1. Show commit activity by author for last 30 days
...
1. Save the report to `reports/commit-report-YYYY-MM-DD.md`
1. Commit and push the report to the repository
