...
1. **Review dashboards**
   ...
   - [Open PRs awaiting review](https://github.com/{{ORG_NAME}}/.github/pulls?q=is%3Apr+is%3Aopen+label%3Aawaiting-review)
   - [Issues needing triage](https://github.com/{{ORG_NAME}}/.github/issues?q=is%3Aissue+is%3Aopen+label%3Aneeds-triage)
   - [Blocked items](https://github.com/{{ORG_NAME}}/.github/issues?q=is%3Aopen+label%3A%22status%3A+blocked%22)
   - [Critical items](https://github.com/{{ORG_NAME}}/.github/issues?q=is%3Aopen+label%3A%22priority%3A+critical%22)
...
- [Actions tab](https://github.com/{{ORG_NAME}}/.github/actions)
...
- [Needs triage](https://github.com/{{ORG_NAME}}/.github/issues?q=is%3Aissue+is%3Aopen+label%3Aneeds-triage)
- [Awaiting review](https://github.com/{{ORG_NAME}}/.github/pulls?q=is%3Apr+is%3Aopen+label%3Aawaiting-review)
- [Blocked items](https://github.com/{{ORG_NAME}}/.github/issues?q=is%3Aopen+label%3A%22status%3A+blocked%22)
- [Critical](https://github.com/{{ORG_NAME}}/.github/issues?q=is%3Aopen+label%3A%22priority%3A+critical%22)
- [Stale](https://github.com/{{ORG_NAME}}/.github/issues?q=is%3Aopen+label%3Astale)
