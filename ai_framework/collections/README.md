---
name: Readme
description: Collection for Readme.
tags: []
updated: 2026-01-20
---
...
Curated sets of prompts, instructions, and chat modes organized by theme or use case.

## 📚 Collection Standards

All collections in this directory follow standardized formatting rules. See [SCHEMA.md](SCHEMA.md) for complete details.
...
- **File Formats**: Both `.yml` (machine-readable) and `.md` (human-readable) versions
...
Model Context Protocol (MCP) collections provide complete toolkits for building MCP servers across 11+ programming languages.
...
2. **Components**: Include instruction, prompt, and chat-mode resources
3. **Tags**: Must include `mcp`, `model-context-protocol`, and language-specific tags
4. **Description**: Follow standard format mentioning "Model Context Protocol" and SDK details
...
- **Full catalog**: [docs/README.collections.md](../../docs/README.collections.md)
