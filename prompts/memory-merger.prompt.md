...
1. **Minimal redundancy** - Overlapping guidance consolidated
1. **Maximum scannability** - Clear hierarchy, parallel structure, strategic
...
1. Evaluate against quality bar
1. Refine structure, wording, organization
1. Repeat until the merged instructions meet 10/10 criteria
