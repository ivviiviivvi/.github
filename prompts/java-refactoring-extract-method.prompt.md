...
## title: 'Refactoring Java Methods with Extract Method' mode: 'agent' description: 'Refactoring using Extract Methods in Java Language'
...
that represents **Extract Method**.
...
Apply **Extract Method** to improve readability, testability, maintainability,
...
- For each qualifying method, identify code blocks that can be extracted into
  separate methods.
...
Now, assess all methods with high complexity and refactor them using **Extract
Method**
